...
// ──────────────────────────────────────────
// Mock feed data — replace with Supabase
// ──────────────────────────────────────────
const MOCK_PROJECTS = [
  {
    id: "p1",
    title: "SolarGrid Africa — Rural Solar Micro-grids",
    company: "SolarGrid Ltd.",
    country: "Kenya",
    category: "cleantech",
    stage: "Seed",
    amountSeeking: "€500,000",
    summary:
      "We are deploying community-owned solar micro-grids across off-grid villages in rural Kenya, providing clean, reliable electricity to 200,000+ households by 2028. Our pay-as-you-go model reduces upfront costs for communities and generates recurring revenue.",
    views: 312,
    interests: 18,
    postedAt: "2 days ago",
    logo: null,
  },
  {
    ...
    category: "fintech",
    stage: "Pre-Seed",
    amountSeeking: "€150,000",
    summary:
      "AgriPay enables instant mobile payments for smallholder farmers across Ghana, removing the friction of cash-based supply chains. We've processed over 50,000 transactions in our first pilot season, achieving 40% cost reduction for cooperatives.",
    views: 198,
    interests: 9,
    postedAt: "5 days ago",
    logo: null,
  ...
  {
    id: "p3",
    title: "EduReach — Offline-First Learning for Rural Schools",
    company: "EduReach Africa",
    country: "Nigeria",
    category: "edtech",
    stage: "Series A",
    amountSeeking: "€1,500,000",
    summary:
      "EduReach delivers curriculum-aligned digital education via ruggedised tablets with offline sync, targeting 3,000 rural schools across Nigeria. We are STEM-certified and operating in 12 states with proven learning outcome improvements of 35%.",
    views: 541,
    interests: 34,
    postedAt: "1 week ago",
    logo: null,
  ...
  {
    id: "p4",
    title: "ColdChain Express — Perishables Logistics Network",
    company: "ColdChain Ventures",
    country: "South Africa",
    category: "logistics",
    stage: "Growth / Expansion",
    amountSeeking: "€3,000,000",
    summary:
      "We operate a network of temperature-controlled logistics hubs across 8 South African provinces, serving FMCG brands and supermarket chains with last-mile cold-chain delivery. Revenue grew 280% YoY. Seeking growth capital to expand into East Africa.",
    views: 890,
    interests: 61,
  ...
  {
    id: "p5",
    title: "MediConsult — Pan-African Telemedicine",
    company: "MediConsult Ltd.",
    country: "Rwanda",
    category: "healthtech",
    stage: "Seed",
    amountSeeking: "€750,000",
    summary:
      "MediConsult connects patients in 6 African countries with qualified doctors via video and text, focusing on underserved rural populations. 100,000 consultations completed. Partnered with 3 national health ministries.",
    views: 427,
    interests: 27,
  ...
  {
    id: "p6",
    title: "BuildRight — Affordable Housing PropTech",
    company: "BuildRight Systems",
    country: "Ethiopia",
    category: "proptech",
    stage: "Series A",
    amountSeeking: "€2,500,000",
    summary:
      "BuildRight uses prefabricated construction technology and a digital platform to deliver affordable homes 60% faster and 30% cheaper than traditional methods. We have delivered 1,400 units to date and have a pipeline of 8,200 units.",
    views: 673,
    interests: 45,
