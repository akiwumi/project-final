...
const NAV = [
  { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, to: "/entrepreneur/dashboard" },
  { id: "profile", label: "My Profile", icon: User, to: "/entrepreneur/profile" },
  { id: "submit", label: "Submit Project", icon: FolderPlus, to: "/entrepreneur/submit" },
  { id: "feed", label: "Project Feed", icon: Newspaper, to: "/feed" },
  { id: "messages", label: "Messages", icon: MessageSquare, to: "/entrepreneur/dashboard#chat" },
];
...
export function EntrepreneurSidebar({ active }) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 min-h-screen bg-[var(--ds-bg-dark)] text-[var(--ds-text-on-dark)] pt-6 pb-10 px-4 shrink-0">
      ...
      <p className="mb-6 px-2 text-xs text-[var(--ds-text-on-dark)]/60">
        Signed in as {displayName || "your account"}
      </p>
